  ...
  return (
    <section className="flex items-center justify-center flex-col text-gray-700">
      ...
      <div className={cn(
        ...
        Explore new destinations and effortlessly plan your trips with WanderWise&apos;s easy-to-use drag & drop interface. Travel planning made simple and fun.
      </div>
      <Button
        className="my-4"
        variant="primary"
